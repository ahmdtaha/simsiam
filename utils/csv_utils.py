...
def write_generic_result_to_csv(**kwargs):
    ...
    save_path = os.path.join(path, "{}.csv".format(exp_name))
    ...
    with open(save_file, "a+") as f:
        f.write(
                ','.join([str(kwargs[k]) for k in keys])
            )
        f.write('\n')


if __name__ == '__main__':
    write_generic_result_to_csv(path='./',name='test5',acc='100',r1='67')
